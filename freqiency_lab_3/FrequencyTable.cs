...
namespace WinFormsApp1
{
    internal class FrequencyTable
    {
        ...
        public static List<(char Symbol, float CalcPercent, float StandartPercent)> FrequencyTableList(in string NameFile,string Lang) // "file" "text"
        {
 
            var AllSymbols = FrequencyTable.FileRead(NameFile);
